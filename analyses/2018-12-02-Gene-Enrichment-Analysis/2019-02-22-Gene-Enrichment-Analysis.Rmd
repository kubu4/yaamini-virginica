...
```{r}
uniqueBackgroundmRNAUniprot <- subset(backgroundmRNAUniprot, !duplicated(backgroundmRNAUniprot$Genbank)) #Subset the unique Genbank IDs from backgroundmRNAUniprot and save as a new dataframe.
head(uniqueBackgroundmRNAUniprot) #Confirm changes
```
