...
## Merge Uniprot codes with gene background
...
The first thing I need to do is merge the txt file of DMR-mRNA overlaps with the *C. virginica* genome-Uniprot codes.

```{bash}
head 2018-09-11-Transcript-Uniprot-blastx-codeIsolated.txt #Check file format
```
