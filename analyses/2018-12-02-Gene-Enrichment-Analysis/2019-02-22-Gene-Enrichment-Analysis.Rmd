...
```{r}
allDMLclosestBed <- merge(x = closestDML, y = allDML, by = "start") #Merge closest information and DML list
...
```{r}
allDMLclosestBedgeneList <- merge(x = allDMLclosestBed, y = geneList, by = c("gene-start", "gene-end")) #Merge dataframes by gene start and end positions
...
```{r}
allDMLclosestBedgeneListmRNAList <- merge(x = allDMLclosestBedgeneList, y = mRNAList, by = "gene-ID") #Merge dataframes by gene ID
...
```{r}
allDMLclosestBedgeneListmRNAListUniprot <- merge(x = allDMLclosestBedgeneListmRNAList, y = blastResults, by = "Genbank") #Merge DML list with Uniprot codes by Genbank IDs
