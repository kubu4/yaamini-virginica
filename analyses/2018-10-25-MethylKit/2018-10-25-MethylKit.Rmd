...
fileName <- data.frame("nameBase" = rep("2018-10-25-Percent-CpG-Methylation", times = nFiles),
                       "nameBase2" = rep("2018-10-25-Percent-CpG-Coverage", times = nFiles),
...
```{r}
jpeg(filename = "2018-10-25-Full-Sample-Pearson-Correlation-Plot-Cov3.jpeg", height = 1000, width = 1000) #Save file with designated name
...
```{r}
jpeg(filename = "2018-10-25-Full-Sample-CpG-Methylation-Clustering-Cov3.jpeg", height = 1000, width = 1000) #Save file with designated name
...
```{r}
jpeg(filename = "2018-10-25-Genefish-Samples/2018-10-18-Full-Sample-Methylation-PCA-Cov3.jpeg", height = 1000, width = 1000) #Save file with designated name
PCASamples(methylationInformationCov3) #Run a PCA analysis on percent methylation for all samples
dev.off() #Turn off plotting device
```

```{r}
jpeg(filename = "2018-10-25-Full-Sample-Methylation-Screeplot-Cov3.jpeg", height = 1000, width = 1000) #Save file with designated name
...
```{r}
write.csv(diffMethStats50Cov3, "2018-10-25-Genefish-Samples-Differentially-Methylated-Loci-50-Cov3.csv") #Save table as .csv
```
